...
const WhyMatcheroSection = ({ className = '' }: WhyMatcheroSectionProps) => {
  ...
  const integrations = [
    { name: 'ORACLE', color: 'text-red-600', image: '/partner/Oracle_logo 1.svg' },
    { name: 'LinkedIn', color: 'text-blue-600', image: '/partner/LinkedIn_2021 1.svg' },
    { name: 'workday.', color: 'text-gray-700', image: '/partner/Workday_Logo_0 1.svg' },
    { name: 'matchero', color: 'text-green-600', subtitle: 'ATS, Hiring & Onboarding', image: '/logo.svg' },
    { name: 'Google Drive', color: 'text-blue-500', image: '/partner/Google.png' },
    { name: 'bo', color: 'text-green-600', image: '/partner/338d20c8723f9c93bca1046de48ea40f1e6450be.png' }
  ];
      ...
      <div className="w-full px-16 relative z-10">
        ...
        <div className="text-center">
          ...
          <div className="w-full mb-12">
            ...
            <div className="hidden md:flex justify-between items-center w-full">
              {integrations.map((integration, index) => (
                <div key={index} className="flex flex-col items-center flex-1 integration-logo-container">
                  <img 
            ...
            <div className="md:hidden overflow-x-auto">
              <div className="flex space-x-8 pb-4" style={{ width: `${integrations.length * 120}px` }}>
                {integrations.map((integration, index) => (
          ...
          <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Our platform connects effortlessly with the tools you already use, from job boards and CRMs to communication platforms and HR software. As your team grows, Matchero grows with you.
          </p>
        </div>
      </div>
    </section>
